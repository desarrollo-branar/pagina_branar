...
<main>
    ...
    <section class="info-service-art">
        ...
        <div class="border_img_large personal_image" style="width: 400px; height: 400px;">
        </div>
    </section>
    ...
    <section class="box_container general-padding general-margin">
        ...
        <article class="box_info">
            <div>
                <img src="../assets/images/foto_personal_large2.JPG" alt="">
            </div>
            <div class="">
    ...
    <section class="mision_vision general-margin general-padding " style="background-image: url(../assets/images/nube.jpg);">
