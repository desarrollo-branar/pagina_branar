    ...
    <div class="row">
      <div class="col-sm-8">
        <ul>
          <li>
            <a href="{{ route('index') }}">
              <img src="{{ asset('images/logo-para-fondo-oscuro.png') }}" class="image_footer"
                alt="Branar - Servicios en Tecnología">
            </a>
          </li>
        </ul>
      </div>
  ...
  <div class="footer_container">
    <div class="footer_column">
      ...
      <ul>
        ...
        <li><a href="{{ route('servicepack') }}" class="underline-footer">ServiPack<span class="icon-dot"></span></a></li>
        <li><a href="{{route ('dev_web') }}" class="underline-footer">Desarrollo Web<span class="icon-dot"></span></a></li>
      </ul>
    </div>
    <div class="footer_column">
      <header>
      ...
      <ul>
        <li><a href="{{ route('about') }}" class="underline-footer">Quienes somos?<span class="icon-dot"></span></a>
        </li>
        <li>
  ...
  <div class="container mt-4">
    <div class="row">
      <div class="col-sm-12 d-flex justify-content-center">
        <p style="color: #6c6c6c; text-align: center;">Branar, C.A. J-310451397 © Copyright 2023 Todos los
