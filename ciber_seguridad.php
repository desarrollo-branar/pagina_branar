  ...
  <footer class="footer">
    ...
    <div class="footer_container">
      <div class="footer_column">
        ...
        <ul>
          <li>
            <a href="csa.html" class="underline-footer">Csa Epson<span class="icon-dot"></span></a>
          </li>
          <li>
            <a href="infraestructure.html" class="underline-footer">Infraestructura<span class="icon-dot"></span></a>
          </li>
          <li>
            <a href="social-media.html" class="underline-footer">SocialMedia<span class="icon-dot"></span></a>
          </li>
          <li>
            <a href="profitplus.html" class="underline-footer">Profit Plus<span class="icon-dot"></span></a>
          </li>
          <li>
            <a href="servipack.html" class="underline-footer">ServiPack<span class="icon-dot"></span></a>
          </li>
          <li>
            <a href="devweb.html" class="underline-footer">Desarrollo Web<span class="icon-dot"></span></a>
          </li>
        </ul>
      </div>
      <div class="footer_column">
        ...
        <ul>
          <li>
            <a href="aboutme.html" class="underline-footer">Quienes somos?<span class="icon-dot"></span></a>
          </li>
          <li>
          ...
          <li>
            <a href="https://wa.link/rc1mal" target="_blink" class="underline-footer">
      ...
      <div class="footer_column">
        ...
        <ul>
          <li>
            <a href="contact.html" class="underline-footer">Contactanos<span class="icon-dot"></span></a>
          </li>
        </ul>
      </div>
      <div class="footer_column">
        ...
        <div>
          ...
          <p>
            Dirección: Av. Libertador, Cruce Calle 41, Local 41-12.
            Barquisimeto-Lara.
          </p>
      ...
      <div class="row">
        <div class="col-sm-12 d-flex justify-content-center">
          <p style="color: #6c6c6c; text-align: center">
            Branar, C.A. J-310451397 © Copyright 2023 Todos los derechos
            reservados.
          </p>
        </div>
      </div>
